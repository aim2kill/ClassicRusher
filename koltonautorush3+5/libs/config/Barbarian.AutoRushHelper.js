...
function LoadConfig() {
	...
	Scripts.BattleOrders = true;
		...
		Config.BattleOrders.Getters = [AutoRush.Rusher.charName, AutoRush.PalaHelper.charName]; // List of players to wait for before casting Battle Orders (mode 0). All players must be in the same area as the BOer.
		...
		Config.BattleOrders.Wait = 20; // Duration to wait for players to join game in seconds (default: 10)
	...
	*/
	...
	Config.AttackSkill[1] = 147; // Primary skill to bosses.
	Config.AttackSkill[2] = 147; // Primary skill to others.
	...
	Config.LowManaSkill[0] = 133; // Low mana skill.
