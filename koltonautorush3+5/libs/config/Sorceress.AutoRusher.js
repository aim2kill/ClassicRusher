...
function LoadConfig() {
	...
	Scripts.AutoRusher = 1;
		...
		// Config.Rusher.GiveWps = false; // Give all Wps (Haven't test it yet....)
	...
	*/
	...
	Config.QuitList = [AutoRush.BarbHelper.charName, AutoRush.PalaHelper.charName];
	...
	Config.RepairPercent = 90; // Durability percent of any equipped item that will trigger repairs.
	...
	Config.AttackSkill[2] = sdk.skills.FireBall; // Primary untimed skill to bosses. Keep at -1 if Config.AttackSkill[1] is untimed skill.
	Config.AttackSkill[3] = sdk.skills.Blizzard; // Primary skill to others.
	Config.AttackSkill[4] = sdk.skills.FireBall; // Primary untimed skill to others. Keep at -1 if Config.AttackSkill[3] is untimed skill.
	Config.AttackSkill[5] = sdk.skills.Meteor; // Secondary skill if monster is immune to primary.
	Config.AttackSkill[6] = sdk.skills.IceBlast; // Secondary untimed skill if monster is immune to primary untimed.
